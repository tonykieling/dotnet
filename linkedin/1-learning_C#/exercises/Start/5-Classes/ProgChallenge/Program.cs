...
namespace ProgChallenge
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Checking balance is {checking.Balance:C2}");
            Console.WriteLine($"1- Savings balance is {saving.Balance:C2}");

            // Apply the Savings interest
            saving.ApplyInterest();
            // Savings balance should now be 1050.63 
            Console.WriteLine($"11- Savings balance is {saving.Balance:C2}");
            ...
            Console.WriteLine($"Checking balance is {checking.Balance:C2}");
            string b = checking.Balance < 0 ? $"({checking.Balance * -1:C2})" : $"{checking.Balance:C2}";
            Console.WriteLine($"Checking balance is {b}");
            Console.WriteLine($"Savings balance is {saving.Balance:C2}");
        }
    }
}

...
namespace RefAndOutParams {
    class Program {
        ...
        static void TestFunc1(int arg1) {
            arg1 += 10;
            Console.WriteLine($" in the function: {arg1}");
        }
        ...
        static void PlusTimes(int arg1, int arg2, out int sum, out int product) {
            ...
            Console.WriteLine($" inside the function, sum = {sum} & product = {product}");
        }
        ...
        static void Main(string[] args) {
            ...
            Console.WriteLine($"val1 before: {val1}");
            TestFunc1(val1);
            Console.WriteLine($"val1 after:: {val1}\n");

            // TODO: Using the "ref" keyword, arguments can be passed by reference
            // which allows the function to modify them
            Console.WriteLine($"val2 before: {val2}");
            TestFunc2(ref val2);
            Console.WriteLine($"val2 after:: {val2}\n");

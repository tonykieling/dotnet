...
// Console.WriteLine($"casting (char)(c + a) = {(char)(c + a)}");  // explicit conversion
...
Console.WriteLine($"before - {s1.a}, {s1.b}");
StructOp(s1);
Console.WriteLine($"after - {s1.a}, {s1.b}\n");
...
Console.WriteLine($"before - {cl.a}, {cl.b}");
ClassOp(cl);
Console.WriteLine($"after - {cl.a}, {cl.b}");
...
// - when they are called, it is passed a copy of the arguments and the return will NOT change the origin value
struct s {
    public int a;
    public bool b;
}

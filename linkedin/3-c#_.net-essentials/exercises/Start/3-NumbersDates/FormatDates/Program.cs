...
Console.WriteLine($"{AprFools.ToString("d", CultureInfo.CreateSpecificCulture("pt-BR"))}");

// TODO: Defining custom date and time formats
Console.WriteLine($"{AprFools:dddd, MMMM, d yyyy}");
Console.WriteLine($"{AprFools:ddd - MM, d yyyy}");
Console.WriteLine($"{AprFools:dddd, dd 'of' MMMM 'of' 'year' yy}");
